...
class BasicTranslation(BasicNotepage):
    def BuildPage(self):
        ...
        self.translationText.config(
            yscrollcommand=self.translationScrollBar.set)
        self.translationScrollBar.config(
            command=self.translationText.yview)
