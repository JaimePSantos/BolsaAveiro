...
def myTextFrame(f, row, col, width, height, stick, colspan, bg=None, fg=None, bd=None, font=None, yscrollcommand=None,
                xscrollcommand=None):
    textTxt = tk.Text(f, width=width, height=height, bg=bg, fg=fg, bd=bd, font=font, yscrollcommand=yscrollcommand,
                      xscrollcommand=xscrollcommand)
    textTxt.grid(row=row, column=col, sticky=stick, columnspan=colspan)
    return textTxt


def myListBoxFrame(f, row, col, width, height, stick, colspan, bg=None, fg=None, bd=None, font=None,
                   yscrollcommand=None, xscrollcommand=None):
    textTxt = tk.Listbox(f, width=width, height=height, bg=bg, fg=fg, bd=bd, font=font, yscrollcommand=yscrollcommand,
                         xscrollcommand=xscrollcommand)
    textTxt.grid(row=row, column=col, sticky=stick, columnspan=colspan)
    return textTxt
