...
from idDL2DL.core.Errors import IllegalCharError, ExpectedCharError
from idDL2DL.core.Tokens import TT_INT, TT_FLOAT, TT_EOF, TT_LOWERLIM, TT_UPPERLIM, TT_SEPARATOR, TT_INTERVALPLUS, \
