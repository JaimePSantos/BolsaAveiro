...
# -- Project information -----------------------------------------------------
project = 'idDL2DL'
copyright = '2022, Jaime Santos, Daniel Figueiredo, Alexandre Madeira'
author = 'Jaime Santos, Daniel Figueiredo, Alexandre Madeira'
release = '2022'
...
# external links
extlinks = {
    "issue": ("https://github.com/JaimePSantos/idDL2DL/issues/%s", "#"),
    "pr": ("https://github.com/JaimePSantos/idDL2DL/pulls/%s", "#"),
}
