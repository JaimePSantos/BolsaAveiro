...
class BasicTranslation(BasicNotepage):
    def BuildPage(self):
        ...
        self.translationText = myTextFrame(f1,row=0, col=0, width=100,height=13 , stick='W',colspan=100)
        ...
        self.translatedText = myTextFrame(f2,row=4, col=0,width=100,height=13,stick='W',colspan=100)
